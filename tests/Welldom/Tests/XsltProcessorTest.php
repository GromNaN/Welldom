...
// ->transformToXml()
    ...
    public function testTransformToXmlError()
    {
        ...
        $this->assertEquals('<movies><movie>The Matrix</movie><movie>Titanic</movie><movie>The Sixth Sense</movie></movies>', $xml, '->transformToXml() returns XM in case of warning');
        $this->assertFalse($xslt->getParameter('', 'param'), '->transformToXml() reset parameters');
